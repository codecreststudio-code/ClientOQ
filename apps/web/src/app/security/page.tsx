    ...
    <div className="min-h-screen bg-canvas text-ink flex flex-col font-sans selection:bg-primary selection:text-on-primary">
      ...
      <main className="flex-1 max-w-4xl mx-auto w-full py-20 px-8 flex flex-col gap-12" id="main-content">
        <div className="flex flex-col gap-4 text-center max-w-2xl mx-auto">
          <span className="text-[10px] font-semibold text-primary tracking-widest">[ Core Security ]</span>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mt-6">
          <div className="bg-canvas-soft border border-hairline p-6 rounded-lg hover:border-mute/40 transition-colors starbucks-shadow">
            <div className="w-10 h-10 rounded bg-primary/10 border border-primary/20 flex items-center justify-center text-primary mb-4">
              <Shield size={20} />
            </div>
            <h2 className="text-md font-bold font-sans tracking-tight text-ink">Global Throttling & Rate Limits</h2>
          ...
          <div className="bg-canvas-soft border border-hairline p-6 rounded-lg hover:border-mute/40 transition-colors starbucks-shadow">
            ...
            <h2 className="text-md font-bold font-sans tracking-tight text-ink">SSL & Environment CORS</h2>
            <p className="text-body-text text-xs mt-2 font-sans leading-relaxed">
          ...
          <div className="bg-canvas-soft border border-hairline p-6 rounded-lg hover:border-mute/40 transition-colors starbucks-shadow">
            ...
            <h2 className="text-md font-bold font-sans tracking-tight text-ink">Single-Tenant Database Files</h2>
            <p className="text-body-text text-xs mt-2 font-sans leading-relaxed">
          ...
          <div className="bg-canvas-soft border border-hairline p-6 rounded-lg hover:border-mute/40 transition-colors starbucks-shadow">
            ...
            <h2 className="text-md font-bold font-sans tracking-tight text-ink">Server-to-Server Webhook Auth</h2>
            <p className="text-body-text text-xs mt-2 font-sans leading-relaxed">
        ...
        <div className="bg-canvas-soft border border-hairline p-8 rounded-lg text-center flex flex-col items-center gap-4 mt-8 starbucks-shadow">
          <h3 className="text-lg font-bold text-ink font-serif italic">Have a security question?</h3>
