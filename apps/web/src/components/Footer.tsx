...
export default function Footer() {
  return (
    <footer className="w-full border-t border-white/10 bg-[#1E3932] pt-16 pb-12 px-8 select-none text-white">
      <div className="max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-12 gap-8 mb-12">
        ...
        <div className="md:col-span-4 flex flex-col gap-4">
          <a href="/" className="flex items-center gap-2.5 hover:opacity-90 transition-opacity w-fit">
            <div className="w-8 h-8 rounded-full bg-[#00754A] flex items-center justify-center font-bold text-white text-sm font-sans shadow-sm select-none">
              Q
            </div>
            <span className="font-bold tracking-tight text-sm uppercase font-mono text-white">Clientoq</span>
          </a>
          ...
          <div className="flex gap-2.5 mt-2">
            {[
              ...
              <a 
                ...
                className="w-8 h-8 rounded-full border border-white/20 flex items-center justify-center text-white/70 hover:text-white hover:border-white/50 transition-all active:scale-95"
              >
        ...
        <div className="md:col-span-2 flex flex-col gap-3 font-sans text-xs">
          <span className="font-bold text-white uppercase tracking-wider text-[10px] select-none">Product</span>
        ...
        {/* Company Column */}
        <div className="md:col-span-2 flex flex-col gap-3 font-sans text-xs">
          <span className="font-bold text-white uppercase tracking-wider text-[10px] select-none">Company</span>
        ...
        {/* Legal Column */}
        <div className="md:col-span-2 flex flex-col gap-3 font-sans text-xs">
          <span className="font-bold text-white uppercase tracking-wider text-[10px] select-none">Legal</span>
          ...
          <a href="/refund-and-cancellation" className="text-white/70 hover:text-white transition-colors">Refund & Cancellation</a>
        </div>
 
        {/* Get started Column */}
        <div className="md:col-span-2 flex flex-col gap-3 font-sans text-xs">
          <span className="font-bold text-white uppercase tracking-wider text-[10px] select-none">Get started</span>
          <a href="/join-waitlist" className="text-white/70 hover:text-white transition-colors">Join the waitlist</a>
          <a href="/?auth=login" className="text-white/70 hover:text-white transition-colors">Sign in</a>
          <a href="/pricing" className="text-white/70 hover:text-white transition-colors">See pricing</a>
        </div>
      </div>
 
      {/* Bottom section */}
      <div className="max-w-6xl mx-auto border-t border-white/10 pt-8 flex flex-col md:flex-row items-center justify-between gap-4 font-mono text-[9px] uppercase tracking-wider text-white/50">
